...
The exact fields are wired in [`src/adapters/channel/loadEnabledChannels.ts`](https://github.com/Gucc111/PilotDeck/blob/feat/cleanup/src/adapters/channel/loadEnabledChannels.ts). Common examples:
