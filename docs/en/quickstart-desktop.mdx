...
PilotDeck provides a native macOS desktop app based on Electron. The universal installer supports both Apple Silicon and Intel Macs.

## Standard Install

<Steps>
  <Step title="Download and open the DMG">
    Download the latest macOS installer from [GitHub Latest Release](https://github.com/OpenBMB/PilotDeck/releases/latest).
  </Step>
...
On first launch, the app guides you through API key setup. For details, see [Config File Reference](/docs/en/reference/config-yaml).
...
<CardGroup cols={2}>
  ...
  <Card title="Core Features" icon="star" href="/docs/en/features/gateway">
