...
<Steps>
  <Step title="Download and open the DMG">
    Go to the <a href="https://github.com/OpenBMB/PilotDeck/releases/latest" style={{color: '#2563EB'}}>PilotDeck latest Release page</a>, download the Apple Silicon DMG file, then double-click the downloaded file.
  </Step>
