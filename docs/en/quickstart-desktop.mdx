...
<Steps>
  <Step title="Download and open the DMG">
    Go to the <a href="https://github.com/OpenBMB/PilotDeck/releases/tag/v0.0.9" style={{color: '#2563EB'}}>PilotDeck v0.0.9 Release page</a>, download the Apple Silicon DMG file, then double-click the downloaded file.
  </Step>
