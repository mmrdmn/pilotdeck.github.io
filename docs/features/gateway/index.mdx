...
具体字段看 [`src/adapters/channel/loadEnabledChannels.ts`](https://github.com/OpenBMB/PilotDeck/blob/main/src/adapters/channel/loadEnabledChannels.ts) 里的 loader。常见示例：
