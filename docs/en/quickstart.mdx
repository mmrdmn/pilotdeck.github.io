...
**Settings** → **Service Config** → **Model Pool** → **Add Provider** → **Select Vendor** → **Enter API Key, URL, etc.** → **Save and Reload**

<img className="quickstartImage" src="/pilotdeck.github.io/img/docs/quickstart/en/quickstart-en-setting-provider.gif" alt="Add Provider" />

### Set/Change Main Model

**Settings** → **Service Config** → **Agent** → **Main Agent Model** → **Select** → **Save and Reload**

<img className="quickstartImage" src="/pilotdeck.github.io/img/docs/quickstart/en/quickstart-en-setting-agent.gif" alt="Set/Change Main Model" />
...
**Settings** → **Service Config** → **Router** → **Choose your model configuration** → **Save and Reload**

<img className="quickstartImage" src="/pilotdeck.github.io/img/docs/quickstart/en/quickstart-en-setting-router.gif" alt="Configure Cost-Saving Routing" />
